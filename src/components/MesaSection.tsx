    ...
    <section className="bg-brand-primary text-brand-secondary py-32 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-20 text-center">
          <Link href="/la-mesa">
            <button className="border border-white/20 px-10 py-4 text-[10px] font-sans font-bold tracking-[0.3em] uppercase hover:bg-[#C2A878] hover:text-brand-primary hover:border-[#C2A878] transition-all duration-500 rounded-full">
              Explorar La Mesa
            </button>
          </Link>
        </div>
